...
/*--------------------------------------------------------------------*/
/*--- x86/Dragonfly-specific kernel interface.     vki-x86-dragonfly.h ---*/
/*--------------------------------------------------------------------*/
...
/*
   ...
   Copyright (C) 2009 Stanislav Sedov <stas@Dragonfly.org>
...
#ifndef __VKI_X86_DRAGONFLY_H
#define __VKI_X86_DRAGONFLY_H
