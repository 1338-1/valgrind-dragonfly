...
int main(int argc, char** argv, char** envp)
{
   ...
   /* Select a platform to use if we can't decide that by looking at
      ...
      mode. */
   if (0==strcmp(VG_PLATFORM,"x86-dragonfly"))
      default_platform = "x86-dragonfly";
   else if (0==strcmp(VG_PLATFORM,"amd64-dragonfly"))
      default_platform = "amd64-dragonfly";
   else
