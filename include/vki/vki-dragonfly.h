...
/*--------------------------------------------------------------------*/
/*--- Dragonfly-specific kernel interface.             vki-dragonfly.h ---*/
/*--------------------------------------------------------------------*/
...
#ifndef __VKI_DRAGONFLY_H
#define __VKI_DRAGONFLY_H
...
#if defined(VGA_x86)
#  include "vki-machine-types-x86-dragonfly.h"
#elif defined(VGA_amd64)
#  include "vki-machine-types-amd64-dragonfly.h"
#else
...
#if defined(VGA_x86)
#  include "vki-x86-dragonfly.h"
#elif defined(VGA_amd64)
#  include "vki-amd64-dragonfly.h"
#elif defined(VGA_ppc32)
#  include "vki-ppc32-dragonfly.h"
#elif defined(VGA_ppc64)
#  include "vki-ppc64-dragonfly.h"
#else
#  error Unknown platform
#endif

//----------------------------------------------------------------------
// linux and dragonfly version hacks
//----------------------------------------------------------------------
#ifndef ELFMAG
...
#define _VKI_IOC_NRBITS		8	/* "num" on dragonfly */
#define _VKI_IOC_TYPEBITS	8	/* "group" on dragonfly */
...
#define _VKI_IOC_NONE	1U	/* "void" on dragonfly, as a specific mode */
...
#define VKI_F_GETPATH		19	/* retrieve path to file associated with fd */
